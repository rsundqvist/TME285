...
namespace Sphere3DApplication
{
    public partial class Sphere3DMainForm : Form
    {
        ...
        private void noLightToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            sphere2 = new Sphere3D();
            sphere2.Generate(new List<double>() { 2, 64, 2 });
            sphere2.SetUniformColor(Color.FromArgb(255, 255, 0));
            sphere2.Alpha = 0.5f;
        ...
        private void lightFlatShadingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            sphere2 = new Sphere3D();
            sphere2.Generate(new List<double>() { 1, 64, 64 });
            sphere2.AmbientColor = Color.FromArgb(255, 0, 0);
            sphere2.DiffuseColor = Color.FromArgb(255, 0, 0);
            sphere2.SpecularColor = Color.White;
            sphere2.Shininess = 20;
            sphere2.UseLight = true;
            sphere2.SetAlpha(0.5f);
    ...
    /*    private void wireframeAndVerticesToolStripMenuItem_Click(object sender, EventArgs e)
        ...
        private void translucentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //Little sphere2
            Sphere3D smallSphere2 = new Sphere3D();
            smallSphere2.Generate(new List<double>() { 0.5, 64, 64 });
            smallSphere2.AmbientColor = Color.FromArgb(0, 0, 255);
            smallSphere2.DiffuseColor = Color.FromArgb(0, 0, 255);
            smallSphere2.SpecularColor = Color.White;
            smallSphere2.Shininess = 20;
            smallSphere2.SetUniformColor(Color.White); // This color is used ONLY for the wireframe.
            smallSphere2.ShowVertices = false;
            smallSphere2.ShowWireFrame = false;
            smallSphere2.ShowSurfaces = true;
            smallSphere2.UseLight = true;
            smallSphere2.ShadingModel = ShadingModel.Smooth;
